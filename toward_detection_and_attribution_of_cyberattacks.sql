...
--
-- Host: localhost
-- Generation Time: Dec 16, 2021 at 06:24 AM
...
--
-- Database: `toward_detection_and_attribution_of_cyberattacks`
--
CREATE DATABASE IF NOT EXISTS `toward_detection_and_attribution_of_cyberattacks` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `toward_detection_and_attribution_of_cyberattacks`;
...
('g9w193bgdpjfzah34ejgevi5wdq4ck0b', 'eyJ1c2VyaWQiOjd9:1mxSyX:7HrgfG-nHAtIjbdIgswjBpqGBB_q6hI62YKbi6Slr5o', '2021-12-29 12:01:37.874572'),
...
('vf6fmdtv35wzdjc52o6qxye4dswbxsrd', 'eyJ1c2VyaWQiOjV9:1mxRXN:3lpUT04RwySbkPVbsSg30pdyai1o4jgPyEKwwoPEFDQ', '2021-12-29 10:29:29.251003'),
...
(7, 'Arvind', 'Arvind123@gmail.com', 'Arvind', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cyberattack_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_cyberattack_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Source_Ip` varchar(300) NOT NULL,
  `Destination_Ip` varchar(300) NOT NULL,
  `Attack_Details` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=15 ;

--
-- Dumping data for table `remote_user_cyberattack_detection_type`
--

INSERT INTO `remote_user_cyberattack_detection_type` (`id`, `Source_Ip`, `Destination_Ip`, `Attack_Details`, `Prediction`) VALUES
(1, '175.45.176.2', '149.171.126.16', 'HP Data Protector Backup (https://strikecenter.bpointsys.com/bps/strikes/exploits/misc/cve_2011_1729.xml)', 'Exploits'),
(2, '175.45.176.0', '149.171.126.16', 'SunRPC TCP Portmapper GETPORT Request (etherifv3/udp) (https://strikecenter.bpointsys.com/bps/strikes/recon/sunrpc/portmap_tcp/service_udp/etherif_v3_udp.xml)', 'Reconnaissance'),
(3, '175.45.176.0', '149.171.126.15', 'http://www.exploit-db.com/exploits/21523/ (http%3a%2f%2fwww.exploit%2ddb.com%2fexploits%2f21523%2f)CVSS-High (https://strikecenter.bpointsys.com/bps/reference/CVSS/7.8%20%28AV%3aN%2fAC%3aL%2fAU%3aN%2fC%3aN%2fI%3aN%2fA%3', 'Exploits'),
(4, '175.45.176.0', '149.171.126.13', 'CVE 2013-2784 (http://cve.mitre.org/cgi-bin/cvename.cgi?name=2013%2d2784)OSVDB 94940 (http://www.osvdb.org/94940)http://ics-cert.us-cert.gov/advisories/ICSA-13-189-02 (http%3a%2f%2fics%2dcert.us%2dcert.gov%2fadvisories%2fICSA%2d13%2d189%2d02)CVSS-High (https://strikecenter.bpointsys.com/bps/referenc', 'Reconnaissance'),
(5, '175.45.176.2', '149.171.126.17', 'Apple_QuickTime_udta_Atom_Buffer_Overflow_attack (https://strikecenter.bpointsys.com/bps/strikes/generic/ixia/apple_quicktime_udta_atom_buffer_overflow_attack.xml)', 'Generic'),
(6, '175.45.176.0', '149.171.126.13', 'Tri PLC Nano 10 PLC Denial of Service (https://strikecenter.bpointsys.com/bps/strikes/denial/misc/cve_2013_2784_tri_PLC_nano10_dos.xml)', 'DoS'),
(7, '175.45.176.3', '149.171.126.10', 'Shellcode: Solaris SPARC Reverse Connect Shell - metasploit (TCP) (https://strikecenter.bpointsys.com/bps/strikes/shellcode/solaris/reverse_sparc_metasploit_tcp.xml)', 'Shellcode'),
(8, '175.45.176.2', '149.171.126.10', 'Lupper.A XML-RPC Propogation Request Variant 8 (https://strikecenter.bpointsys.com/bps/strikes/worms/linux_lupper_a_xmlrpc_08.xml)', 'Worms'),
(9, '175.45.176.1', '149.171.126.18', 'Backdoor: Cisco Prime LAN Management (https://strikecenter.bpointsys.com/bps/strikes/backdoors/cve_2012_6392.xml)', 'Backdoors'),
(10, '175.45.176.2', '149.171.126.12', 'Cisco SNMP Trap Service GET Request DoS (162) (https://strikecenter.bpointsys.com/bps/strikes/denial/snmp/cisco_snmptrap_snmp_01.xml)', 'DoS'),
(11, '175.45.176.3', '149.171.126.18', 'Shellcode: Linux SPARC Reverse Connect Shell - metasploit (TCP) (https://strikecenter.bpointsys.com/bps/strikes/shellcode/linux/reverse_sparc_metasploit_tcp.xml)', 'Shellcode'),
(12, '175.45.176.2', '149.171.126.16', 'Apple Safari for Windows Beta feed:// URL DoS Variant 5 (https://strikecenter.bpointsys.com/bps/strikes/denial/browser/apple_safari_windows_feed_url_dos_5.xml)', 'DoS'),
(13, '175.45.176.3', '149.171.126.13', 'Fuzzer: SMB Session Setup Invalid Server Domain (NTLMv1) (https://strikecenter.bpointsys.com/bps/strikes/fuzzers/smb/session_setup_ntlmv1_invalid_server_domain.xml)', 'Fuzzers'),
(14, '175.45.176.3', '149.171.126.14', 'SunRPC TCP Portmapper GETPORT Request (mazewarsv3/udp) (https://strikecenter.bpointsys.com/bps/strikes/recon/sunrpc/portmap_tcp/service_udp/mazewars_v3_udp.xml)', 'Reconnaissance');
...
(11, 'Naive Bayes', '98.39449541284404'),
(12, 'SVM', '100.0'),
(13, 'Logistic Regression', '99.94266055045871'),
(14, 'Decision Tree Classifier', '100.0'),
(15, 'KNeighborsClassifier', '99.2545871559633');
...
(59, 'Reconnaissance', '21.428571428571427'),
(60, 'Exploits', '14.285714285714285'),
(61, 'DoS', '21.428571428571427'),
(62, 'Generic', '7.142857142857142'),
(63, 'Fuzzers', '7.142857142857142'),
(64, 'Worms', '7.142857142857142'),
(65, 'Shellcode', '14.285714285714285'),
(66, 'Backdoors', '7.142857142857142');
